...
//#define PTL_HEADER 0xFA         ///< Frame header identifier
    ...
    typedef enum
    {
        ...
        MCU_TO_SOC_MOD_METER = 0x03,     ///< Meter data
        MCU_TO_SOC_MOD_INDICATOR = 0x04, ///< Indicator data
        MCU_TO_SOC_MOD_DRIV_INFO = 0x05, ///< Driving information
        MCU_TO_SOC_MOD_SETUP = 0x06,     ///< Settings
        MCU_TO_SOC_MOD_KEY = 0x07,       ///< KEY
				MCU_TO_SOC_MOD_CAN = 0x08,       ///< CAN
        ...
        SOC_TO_MCU_MOD_METER = 0x83,     ///< Meter data
        SOC_TO_MCU_MOD_INDICATOR = 0x84, ///< Indicator data
        SOC_TO_MCU_MOD_DRIV_INFO = 0x85, ///< Driving information
        SOC_TO_MCU_MOD_SETUP = 0x86,     ///< Settings
        SOC_TO_MCU_MOD_KEY = 0x87,       ///< KEY
        SOC_TO_MCU_MOD_IPC = 0x88,       ///< IPC socket
