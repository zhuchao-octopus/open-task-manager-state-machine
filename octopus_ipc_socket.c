 ...
 *
 * PARAMETERS:
 * - frame_type: Type of the frame (MCU_TO_SOCMOD_SYSTEM, SOC_TO_MCU_MOD_SYSTEM, MCU_TO_SOCMOD_SETUP).
...
bool ipc_socket_receive_handler(ptl_frame_payload_t *payload, ptl_proc_buff_t *ackbuff)
{
    ...
    // Handle received commands for MCU_TO_SOCMOD_SYSTEM frame type
    // if(MCU_TO_SOCMOD_IPC == payload->frame_type)
    {
    }
