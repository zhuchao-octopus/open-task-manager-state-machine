...
#define ADC_CHANNEL_NUM 4   /**< Number of ADC channels, configurable */
#define ADC_SAMPLE_COUNT 16 /**< Number of samples per channel for averaging */
